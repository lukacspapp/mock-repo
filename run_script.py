...
private_repo_url = "https://bitbucket.org/atdtravel/services-admin-react"
private_repo_local_path = "/Users/lukacspapp/phoenix-server/services-admin-react"  # Replace with your desired local path
